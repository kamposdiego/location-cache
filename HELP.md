...
* The original package name 'br.com.morsesystems.location.cache.location-cache' is invalid and this project uses 'br.com.morsesystems.location.cache.locationcache' instead.
